...
8. [Estructura de la aplicación monolítica - dominio](#estructura-de-la-aplicación-monolítica---dominio)
    - [Entidades Principales](#entidades-principales)
    - [Reglas de Negocio Potenciales](#reglas-de-negocio-potenciales)
    - [Estructura de la aplicación monolítica - dominio](#estructura-de-la-aplicación-monolítica---dominio-1)
9. [Módulos](#módulos)
